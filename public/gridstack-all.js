        ...
        958: (e, t, i) => {
          ...
          t.DDGridStack = class {
                  ...
                  e.on(t, (e) => {
                    i(
                      ...
                      o.DDManager.dragElement
                        ? o.DDManager.dragElement.el
                        : e.target,
                      o.DDManager.dragElement
                        ? o.DDManager.dragElement.helper
                        : null
                    );
                  })
                ),
            ...
            _getDDElements(e, t = !0) {
              ...
              if (!i.length) return [];
              let o = i.map(
                (e) => e.ddElement || (t ? n.DDElement.init(e) : null)
              );
        ...
        270: function (e, t, i) {
          ...
          class p {
            constructor(e, t = {}) {
              ...
              let a = t;
              void 0 !== a.minWidth &&
                ((t.oneColumnSize = t.oneColumnSize || a.minWidth),
                delete a.minWidth),
              ...
              e.getAttribute("gs-animate") &&
                (g.animate = r.Utils.toBool(e.getAttribute("gs-animate"))),
              ...
              let c =
                this.opts.engineClass || p.engineClass || n.GridStackEngine;
              if (
                ((this.engine = new c({
              ...
              this.setAnimation(this.opts.animate),
                ...
                this.opts.dragIn &&
                  p.setupDragIn(this.opts.dragIn, this.opts.dragInOptions),
            ...
            static init(e = {}, t = ".grid-stack") {
              let i = p.getGridElement(t);
              return i
                ? (i.gridstack ||
                    (i.gridstack = new p(i, r.Utils.cloneDeep(e))),
                  i.gridstack)
                : ("string" == typeof t
                    ? console.error(
            ...
            static initAll(e = {}, t = ".grid-stack") {
              let i = [];
              return (
                p.getGridElements(t).forEach((t) => {
                  t.gridstack ||
                    ((t.gridstack = new p(t, r.Utils.cloneDeep(e))),
                    delete e.dragIn,
            ...
            addWidget(e, t) {
              ...
              if ("string" == typeof e) {
                ...
                if (((s = t = e), null == s ? void 0 : s.el)) i = s.el;
                  ...
                  i = this.opts.addRemoveCB(this, t, !0);
                else {
                  let e = (null == t ? void 0 : t.content) || "",
                    s = document.implementation.createHTMLDocument("");
                  (s.body.innerHTML = `<div class="grid-stack-item ${
                    this.opts.itemClass || ""
              ...
              return (
                (t = r.Utils.cloneDeep(t) || {}),
                r.Utils.defaults(t, n),
                ...
                s.subGrid && this.makeSubGrid(s.el, void 0, void 0, !1),
                this._prevColumn &&
                  1 === this.opts.column &&
            ...
            makeSubGrid(e, t, i, s = !0) {
              ...
              let a,
                h = e.gridstackNode;
              if (
                (h || (h = this.makeWidget(e).gridstackNode),
                null === (o = h.subGrid) || void 0 === o ? void 0 : o.el)
              )
                return h.subGrid;
              let d,
                g = this;
              for (; g && !a; )
                (a =
                  null === (n = g.opts) || void 0 === n ? void 0 : n.subGrid),
                  (g =
                    null === (l = g.parentGridItem) || void 0 === l
                      ? void 0
                      : l.grid);
              (t = r.Utils.cloneDeep(
                Object.assign(
              ...
              let u,
                c,
                m = h.el.querySelector(".grid-stack-item-content");
              if (s) {
                this._removeDD(h.el);
                ...
                (e.body.innerHTML = '<div class="grid-stack-item"></div>'),
                  (u = e.body.children[0]),
                  u.appendChild(m),
                  (c = Object.assign(Object.assign({}, h), { x: 0, y: 0 })),
                  r.Utils.removeInternalForSave(c),
                  delete c.subGrid,
                  h.content && ((c.content = h.content), delete h.content),
                  (e.body.innerHTML =
                    '<div class="grid-stack-item-content"></div>'),
                  (m = e.body.children[0]),
                  h.el.appendChild(m),
                  this._prepareDragDropByNode(h);
              }
              if (i) {
                let e = d ? t.column : h.w,
                  s = h.h + i.h,
                  o = h.el.style;
                (o.transition = "none"),
                  this.update(h.el, { w: e, h: s }),
                  setTimeout(() => (o.transition = null));
              }
              let v = (h.subGrid = p.addGrid(m, t));
              return (
                (null == i ? void 0 : i._moving) && (v._isTemp = !0),
                d && (v._autoColumn = !0),
                s && v.addWidget(u, c),
                i &&
                  (i._moving
              ...
              if (
                (i.forEach((i) => {
                  ...
                  if (e && i.el && !i.subGrid) {
                    ...
                    (e || delete i.content,
                    null === (s = i.subGrid) || void 0 === s ? void 0 : s.el)
                  ) {
                    const s = i.subGrid.save(e, t);
                    i.subGrid = t ? s : { children: s };
                  }
                  delete i.el;
                }),
                t)
            ...
            load(e, t = this.opts.addRemoveCB || !0) {
              let i = p.Utils.sort(
                [...e],
                -1,
                this._prevColumn || this.getColumn()
              ...
              return (
                ...
                t &&
                  [...this.engine.nodes].forEach((e) => {
                    i.find((t) => e.id === t.id) ||
                      (this.opts.addRemoveCB &&
                        this.opts.addRemoveCB(this, e, !1),
                      o.push(e),
            ...
            static setupDragIn(e, t) {
              void 0 !== (null == t ? void 0 : t.pause) &&
                (d.DDManager.pauseDrag = t.pause),
                "string" == typeof e &&
                  ((t = Object.assign(
                    Object.assign({}, l.dragInDefaultOptions),
                    t || {}
                  )),
                  r.Utils.getElements(e).forEach((e) => {
            ...
            _removeDD(e) {
              return (
                g.draggable(e, "destroy").resizable(e, "destroy"),
              ...
              let e,
                ...
                i = (i, s, o) => {
                  ...
                  let l = this.el.getBoundingClientRect(),
                    { top: a, left: h } = o.getBoundingClientRect();
                  (h -= l.left), (a -= l.top);
                  let d = { position: { top: a, left: h } };
                  if (n._temporaryRemoved) {
                    if (
                      ((n.x = Math.max(0, Math.round(h / t))),
                      (n.y = Math.max(0, Math.round(a / e))),
                      delete n.autoPosition,
                      this.engine.nodeBoundFix(n),
                      !this.engine.willItFit(n))
                    ) {
                      if (((n.autoPosition = !0), !this.engine.willItFit(n)))
                        return void g.off(s, "drag");
                      n._willFitPos &&
                        (r.Utils.copyPos(n, n._willFitPos),
                        delete n._willFitPos);
                    }
                ...
                g
                  ...
                  .on(this.el, "drop", (e, t, i) => {
                    ...
                    if (
                      ...
                      a && (null == h ? void 0 : h.grid) && h.grid !== this)
                    ) {
                      let e = h.grid;
                    ...
                    if (!n) return !1;
                    if (
                      (a && (this.engine.cleanupNode(n), (n.grid = this)),
                      g.off(t, "drag"),
                      i !== t
                        ? (i.remove(),
                          (t.gridstackNode = h),
                    ...
                    let d =
                      null ===
                        (o =
                          null === (s = n.subGrid) || void 0 === s
                            ? void 0
                            : s.el) || void 0 === o
                        ? void 0
                        : o.gridstack;
                    return (
                      r.Utils.copyPos(n, this._readAttr(this.placeholder)),
            ...
            _prepareDragDropByNode(e) {
              ...
              if (!e._initDD) {
                  ...
                  l = (i) => {
                    ...
                    if (s.gridstackNode && s.gridstackNode.grid === this) {
                      if (((e.el = s), e._isAboutToRemove)) {
                        ...
                        r.Utils.removePositioningStyles(s),
                          e._temporaryRemoved
                            ? (r.Utils.copyPos(e, e._orig),
                ...
                g
                  .draggable(t, { start: o, stop: l, drag: n })
                  .resizable(t, { start: o, stop: l, resize: n }),
                  (e._initDD = !0);
              }
              return (
                g
            ...
            _onStartMoving(e, t, i, s, o, n) {
              this.engine.cleanNodes().beginUpdate(s),
                ...
                "resizestart" === t.type &&
                  ...
                  s.maxW && g.resizable(e, "option", "maxWidth", o * s.maxW),
                  s.maxH && g.resizable(e, "option", "maxHeight", n * s.maxH));
            }
              ...
              if (
                ...
                (s._prevYPix = i.position.top),
                  !1 !== this.opts.draggable.scroll &&
                    r.Utils.updateScrollPosition(e, i.position, t);
                let l =
                    i.position.left +
                ...
                (a.x = Math.round(l / o)), (a.y = Math.round(u / n));
                ...
                if (a.x < 0) return;
                if (
                  (r.Utils.updateScrollResize(t, e, n),
